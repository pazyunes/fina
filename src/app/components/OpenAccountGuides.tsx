...
export function OpenAccountGuides() {
  ...
  return (
    <section>
      ...
      <div className="bg-white rounded-xl p-4 border border-[#D7C2EF]/50">
            ...
            return (
              <div
                ...
                className={`rounded-xl border transition-colors ${
                  isOpen ? 'border-[#7626B3] bg-[#F0E7FA]/40' : 'border-gray-200 bg-white'
                }`}
              >
                <button
                  type="button"
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-[#7626B3] shrink-0 transition-transform ${isOpen ? 'rotate-180' : ''}`}
                  />
                </button>
