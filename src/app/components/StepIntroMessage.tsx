...
export function StepIntroMessage({ title, body }: StepIntroMessageProps) {
  return (
    <motion.div
      ...
      className="bg-[#F0E7FA]/70 border border-[#7626B3]/20 rounded-2xl px-5 py-4 mb-5"
    >
      <p className="text-[#7626B3] mb-1" style={{ fontFamily: 'var(--font-serif)', fontSize: '1.15rem' }}>
        {title}
      </p>
