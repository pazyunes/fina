...
export function InvestmentGuideScreen({ guide, onClose }: InvestmentGuideScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#FBEAF0] flex flex-col">
      {/* Header rosa */}
      <div className="bg-[#D4537E] text-white px-5 pt-6 pb-4 shrink-0">
        ...
        <div className="max-w-md mx-auto w-full">
          <AnimatePresence mode="wait">
            ...
            >
              {step === 0 && (
                <div>
                  <h2 className="text-2xl font-bold text-[#D4537E] mb-3" style={{ fontFamily: 'var(--font-serif)' }}>
                    ¿Qué es {guide.title}?
                  </h2>
                  <div
                  ...
                  <div className="bg-white rounded-xl px-4 py-3 mt-4 border-l-[3px] border-[#D4537E] text-sm text-[#993556]">
                    {guide.risk.note}
                  </div>
                </div>
              )}
              ...
              {step === 1 && (
                <div>
                  <h2 className="text-2xl font-bold text-[#D4537E] mb-2" style={{ fontFamily: 'var(--font-serif)' }}>
                    ¿Dónde puedo hacerlo?
                  </h2>
                  ...
                  <div className="space-y-2.5">
                    {guide.apps.map((app) => (
                      <div
                        key={app}
                        className="flex items-center gap-3 bg-white rounded-xl px-4 py-3.5 border border-[#F4C0D1]/50"
                      >
              ...
              {step === 2 && (
                <div>
                  <h2 className="text-2xl font-bold text-[#D4537E] mb-4" style={{ fontFamily: 'var(--font-serif)' }}>
                    Paso a paso
                  </h2>
                  <ol className="space-y-3">
                    {guide.steps.map((s, i) => (
                      <li key={i} className="flex gap-3">
                        <span className="w-7 h-7 rounded-full bg-[#D4537E] text-white text-sm font-bold flex items-center justify-center shrink-0">
                          {i + 1}
                        </span>
                  ...
                  <div className="bg-gradient-to-br from-[#D4537E] to-[#E07499] rounded-2xl px-4 py-4 mt-6 text-white flex gap-3 items-start">
      ...
      {/* Footer navegación */}
      <div className="shrink-0 bg-white/70 backdrop-blur border-t border-[#F4C0D1]/50 px-5 py-4">
        <div className="max-w-md mx-auto w-full flex gap-3">
          ...
          <Button
            onClick={next}
            className="flex-1 bg-[#D4537E] hover:bg-[#C14870] text-white rounded-full"
          >
