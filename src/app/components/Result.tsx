...
import { Flame, TrendingUp, Target, ChevronDown, ChevronUp, CircleUserRound, LogOut } from 'lucide-react';
...
export function Result({ analysis }: ResultProps) {
  ...
  // PR6 — Logout desde el informe. Cierra sesión y vuelve al Splash en `/`.
        ...
        <div className="max-w-3xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="text-gray-500 hover:text-[#D4537E]"
              title="Cerrar sesión"
            >
